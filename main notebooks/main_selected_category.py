...
def processing(history_data_file, requested_formulas_data_file, reference_formulas_data_file, data_date, starting_date_grid_search, category_name_for_export_files = "pigment", raw_material_categories = ["PIGMENT","PATE PIG"]):
    ...
    history_data_file = history_data_file #its a pandas dataframe #"IA BPC Teinte v2.xlsm" #1st needed file
    ...
    SELECTED_MP_CATEGORIES = raw_material_categories
    ...
    df = history_data_file
    requested_formulas_df = requested_formulas_data_file
    reference_df = reference_formulas_data_file
    ...
    LIMIT_INITIALIZATION_DATE = starting_date_grid_search #'2024-03-06'
    ...
    #A CORRIGER
    #enlever : #selected_formulas_ids = {'ZZ2009564', 'ZZ20075801', 'ZZ994006', 'ZZ2008669', 'ZZ20075681', 'ZZ8038374', 'ZZ965980', 'ZZ20086592', 'ZZ966056', 'ZZ20096991', 'ZZ966057', 'ZZ20087052', 'ZZ994073', 'ZZ20087961', 'ZZ2008672', 'ZZ20101141', 'ZZ2009336', 'ZZ994010', 'ZZ994007', 'ZZ994117', 'ZZ20096981', 'ZZ80389118', 'ZZ994009', 'ZZ2010257', 'ZZ994014', 'ZZ965421', 'ZZ8032458', 'ZZ20102072', 'ZZ993770', 'ZZ20091671', 'ZZ2009021', 'ZZ994087', 'ZZ20099511', 'ZZ20097651', 'ZZ9661001'}
    ...
    passed_boolean, best_params, best_metrics, formulas_predictions, metrics_MP, formulas_ids_filtered_out, selected_batches_dict = \
        True, \
        (1, 2, 5, pd.Period('2024-03-06', 'D'), True, 1, 0.35), \
        (3.02684, 91.4), \
        {'ZZ966056': {'80294': 34.4135, '80295': 4.8914, '80296': 5.3064, '80429': 6.2604, '80633': 49.1283}, 'ZZ20096991': {'80294': 13.5138, '80296': 20.4083, '80429': 6.5433, '80633': 59.5346}, 'ZZ994009': {'ZZPPD791611': 1.8821, 'ZZPPD791621': 0.3366, 'ZZPPD791631': 13.0382, 'ZZPPD804013': 84.7431}}, \
        {'ZZ966056': {'80294': -2.23331694553222, '80295': -0.014471618852447335, '80296': 9.252149845201235, '80429': -6.056329296728109, '80633': 1.5314807220179294}, 'ZZ20096991': {'80294': 0.529435403079113, '80296': 0.21977687360575873, '80429': -4.482802590854004, '80633': 0.3221334072026857}, 'ZZ994009': {'ZZPPD791611': -7.622292416747757, 'ZZPPD791621': 1.2174604921256797, 'ZZPPD791631': -5.561533825796505, 'ZZPPD804013': 1.0964332370880026}}, \
        ['ZZ2009564', 'ZZ20075801', 'ZZ994006', 'ZZ2008669', 'ZZ20075681', 'ZZ8038374', 'ZZ965980', 'ZZ20086592', 'ZZ20087052', 'ZZ966057', 'ZZ994073', 'ZZ20087961', 'ZZ2008672', 'ZZ994010', 'ZZ20101141', 'ZZ2009336', 'ZZ994007', 'ZZ994117', 'ZZ20096981', 'ZZ80389118', 'ZZ2010257', 'ZZ994014', 'ZZ965421', 'ZZ8032458', 'ZZ20102072', 'ZZ993770', 'ZZ20091671', 'ZZ2009021', 'ZZ994087', 'ZZ20099511', 'ZZ20097651', 'ZZ9661001'], \
        {'ZZ966056': ['<modules.Batch object at 0x16504f810>', '<modules.Batch object at 0x1291c4e50>', '<modules.Batch object at 0x10f32edd0>'], 'ZZ20096991': ['<modules.Batch object at 0x1285b6e90>', '<modules.Batch object at 0x1666ce850>'], 'ZZ994009': ['<modules.Batch object at 0x166135090>', '<modules.Batch object at 0x1664cedd0>']}
    ...
    print('keys', formulas_predictions.keys())
