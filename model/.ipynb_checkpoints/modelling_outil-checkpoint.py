...
def cleaning_data(factory_df):
    ...
    factory_df_cleaned['starting_date'] = factory_df_cleaned['Heure début'].dt.date
    factory_df_cleaned['starting_time'] = factory_df_cleaned['Heure début'].dt.time

    factory_df_cleaned['ending_date'] = factory_df_cleaned['Heure fin'].dt.date
    factory_df_cleaned['ending_time'] = factory_df_cleaned['Heure fin'].dt.time
    factory_df_cleaned = factory_df_cleaned.drop(['Heure début', 'Heure fin'], axis=1)
